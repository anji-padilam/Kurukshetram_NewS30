...
const BusinessNews = () => {
  ...
  return (
    <section id="business" className="py-12 bg-gray-50 dark:bg-gray-800 font-mandali scroll-mt-24">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">{t("latestMarketTrends")}</p>
        </div>
