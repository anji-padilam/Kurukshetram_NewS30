...
const BreakingNews: React.FC = () => {
  ...
  // Use the same language handling as other components
      ...
      <div className="container mx-auto px-8 lg:px-12 relative">
        <Slider {...settings}>
          {news.map((item: NewsItem) => (
            ...
            >
              <div className="featured-post-item bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="featured-post-content p-4 sm:p-5">
                  ...
                  <h2 className="post-title text-base sm:text-lg md:text-xl font-semibold leading-tight text-gray-900 dark:text-white line-clamp-2">
                    {item.title}
                  </h2>
                </div>
              </div>
