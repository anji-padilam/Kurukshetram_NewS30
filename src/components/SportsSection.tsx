...
const SportsSection = () => {
  ...
  return (
    <section id="sports" className="font-mandali py-12 bg-white dark:bg-gray-800 scroll-mt-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">{t("sports.subtitle")}</p>
        </div>
                    ...
                    <div className="flex flex-col sm:flex-row h-full">
                      ...
                      <div className="sm:w-3/5 flex flex-col justify-between p-4 sm:p-6">
                        <div>
                          ...
                          <CardTitle className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 dark:text-white mb-3 line-clamp-2">
                            {news.title}
                          </CardTitle>
                        </div>
                        <div>
